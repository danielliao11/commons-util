...
import com.saintdan.util.commons.constant.SignatureConstant;
import com.saintdan.util.commons.enums.ErrorType;
import com.saintdan.util.commons.exception.SignatureException;
...
public class SignatureUtils {
    ...
    public static boolean rsaCheckContent(String content, String sign, String publicKey, String charset)
        ...
        try {
            ...
            throw new SignatureException(ErrorType.SGN0001);
        }
    }
